...
internal abstract class BaseItemAnimator : SimpleItemAnimator() {
    ...
    inner class DefaultAddAnimatorListener constructor(
    ...
    protected inner class DefaultRemoveAnimatorListener constructor(
        private val viewHolder: RecyclerView.ViewHolder
    ) : AnimatorListenerAdapter() {
        override fun onAnimationStart(animator: Animator) {
